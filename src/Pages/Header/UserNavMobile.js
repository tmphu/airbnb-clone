      ...
      return (
        <nav className="relative">
          <ul className="flex flex-row gap-x-5 items-center">
            <li>
              <button
                className="bg-white text-black px-2 py-1 rounded-full flex flex-row gap-x-3 items-center"
          ...
          {isShowContextMenu && (
            <div className="bg-white shadow-xl text-gray-600 rounded-lg flex flex-col cursor-pointer absolute w-40 right-0">
              <div className="py-4">
                <NavLink
                  to={"/my-profile"}
                  onClick={() => setIsShowContextMenu(!isShowContextMenu)}
